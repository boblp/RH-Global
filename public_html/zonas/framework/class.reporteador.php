<?php
// Clase que extiende FPDF para obtener reportes del sistema Invex
class Reporteador extends FPDF {
  ...
  function Format($preset="reset") {
    $formats = explode(",",$preset);
...
$r->SetCreator("Sistema RHGlobal - Creado por [Manolo Guerrero]");

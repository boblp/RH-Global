...
function getedc(tid,ver) {
	...
	var ff = (!document.getElementById("factura").checked && document.getElementById("nofact").checked) ? "-f" : ((document.getElementById("factura").checked) ? "-u" : "");
	window.open(targeturl + "/edc/a/" + tid + "/" + ver + "/" + clv + "O" + fiv + "O" + ffv + ff + ".pdf", "", "width=50,height=50,scrollbars=no,menubar=no,menu=no,status=no,statusbar=no");
}